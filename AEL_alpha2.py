...
GraphicFrame = tk.Frame(main, borderwidth = 5, relief = 'ridge', width = 100, height = 100)
GraphicFrame.place(x = 0, anchor = tk.SW, rely = 1)

    #Frame para os Dados
DataFrame = tk.LabelFrame(main, borderwidth = 5, relief = 'ridge')
DataFrame.pack(fill = 'y', expand = False)
DataFrame.place(relx = 1, rely = 0.05, anchor = tk.E)
...
Upload.pack(anchor = 'nw', side = tk.LEFT, fill = 'y')
